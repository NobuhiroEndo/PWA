...
VAPID_PRIVATE_KEY_NUMBER = config('VAPID_PRIVATE_KEY_NUMBER', cast=int)
WEB_PUSH_CONTENT_ENCRYPTION_PRIVATE_KEY_NUMBER = config('WEB_PUSH_CONTENT_ENCRYPTION_PRIVATE_KEY_NUMBER', cast=int)
WEB_PUSH_MAIL_ADDRESS = config('WEB_PUSH_MAIL_ADDRESS')